                                      ...
                                      {loadingDetails ? (
                                        ...
                                        scholarshipDetails && (
                                          <Box id="scholarship-details-description" sx={{ mt: 2 }}>
                                            ...
                                            <Typography><strong>Start Date:</strong> {new Date(scholarshipDetails.start_Date).toLocaleDateString()}</Typography>
                                            <Typography><strong>End Date:</strong> {new Date(scholarshipDetails.End_Date).toLocaleDateString()}</Typography>
                                            <Typography><strong>Submission Deadline:</strong> {new Date(scholarshipDetails.submission_date).toLocaleDateString()}</Typography>
