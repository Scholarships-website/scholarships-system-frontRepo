...
function AcceptedScholarship() {
  ...
  const fetchScholarships = async () => {
    ...
    try {
      ...
      console.log(acceptedScholarships);
    ...
    <>
      <div className="scholarships-admin">
        <div className="mb-2 justify-content-between pb-3">
          <h1 className="ps-4 main-col my-4">Accepted Scholarships</h1>
...
export default AcceptedScholarship