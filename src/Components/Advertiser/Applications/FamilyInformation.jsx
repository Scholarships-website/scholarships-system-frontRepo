            ...
            <CardContent>
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
                    ...
                    <Box sx={{ width: "48%" }}>
                        ...
                        <Typography variant="body2" color="textSecondary">{application.Head_of_the_family || "N/A"}</Typography>
                    </Box>

                    {/* Breadwinner Name */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Breadwinner Name:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.breadwinner || "N/A"}</Typography>
                    </Box>

                    {/* Breadwinner ID */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Breadwinner ID:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.breadwinner_id || "N/A"}</Typography>
                    </Box>

                    {/* Father Work Nature */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Father Work Nature:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.work_nature || "N/A"}</Typography>
                    </Box>

                    {/* Institution Name */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Institution Name:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.institution || "N/A"}</Typography>
                    </Box>

                    {/* Income Category */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Income Category:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.income_category || "N/A"}</Typography>
                    </Box>

                    {/* Does Mother Work */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Does Mother Work:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.Does_mother_work || "N/A"}</Typography>
                    </Box>

                    {/* Other Income */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Other Income:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.any_other_income || "N/A"}</Typography>
                    </Box>

                    {/* Number of Family Members */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Number of Family Members:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.Total_number_of_family_members || "N/A"}</Typography>
                    </Box>

                    {/* Does Student Work */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Does Student Work:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.Does_student_work || "N/A"}</Typography>
                    </Box>

                    {/* Social Affairs Case */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>Social Affairs Case:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.social_affairs_case || "N/A"}</Typography>
                    </Box>

                    {/* UNRWA Card */}
                    <Box sx={{ width: "48%" }}>
                        <Typography variant="body1" sx={{ fontWeight: "bold" }}>UNRWA Card:</Typography>
                        <Typography variant="body2" color="textSecondary">{application.UNRWA_card || "N/A"}</Typography>
                    </Box>
                </Box>
            </CardContent>
        </Card>
