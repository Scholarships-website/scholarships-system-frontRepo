        ...
        <>
            ...
            <div className="image-container">
                {loading ? (
                    ...
                    <iframe src="https://lottie.host/embed/3273877b-6bca-4fe8-9417-c922808af93e/34aOWzVHl5.json" width="700px" height="700px" />
                )}
            </div>
            <div className="calendar-container">
                ...
                {soonDeadlines.length > 0 ? (
                    ...
                    <p>No scholarships with upcoming deadlines.</p>
                )}
            </div>
        </>
    )
