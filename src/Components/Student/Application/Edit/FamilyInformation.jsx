...
function FamilyInformation({ currentStep, totalSteps, prevStep, formData, setFormData, saveStepData, nextStep, applicationDetails }) {
  const validationSchema = Yup.object({
    ...
    any_other_income: Yup.string()
      .required("Please specify if there is other income"),
    ...
    Total_number_of_family_members: Yup.number()
      ...
      .max(50, "Family members count cannot exceed 50"),

    Does_student_work: Yup.string()
      .required("Please specify if the student works"),

    social_affairs_case: Yup.string()
      .required("Please specify if the family is registered as a social affairs case"),

    UNRWA_card: Yup.string()
      .required("Please specify if the family has a UNRWA card"),
  });
